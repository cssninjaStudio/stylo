...
<template>
  <div class="min-h-screen">
    ...
    <Articles :filters="filters" :limit="15">
      ...
      <template #subtitle>
        Here are all the posts written by {{ page.name }}. We hope that you'll
        find what you are looking for. If you like the content below, please
        consider supporting our author by connecting with them on social media.
      </template>
      <template #links>
        <TagLinks>
          <TagLink to="/authors">
